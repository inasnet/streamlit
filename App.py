...
with st.form("chd_form"):
    ...
    with col1:
        age = st.number_input("Âge", min_value=10, max_value=100, value=50) ## on peut faire un slider aussi 
